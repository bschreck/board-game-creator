        ...
        <Card className="w-full max-w-md shadow-xl">
          <CardHeader className="text-center">
            <Link href="/" className="flex items-center justify-center gap-2.5 mb-4">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-violet-700 to-indigo-700 bg-clip-text text-transparent">
                BoardCraft
              </span>
            </Link>
            <CardTitle>Welcome back</CardTitle>
            <CardDescription>Sign in to create and manage your board games</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <form onSubmit={handleDemoLogin} className="space-y-4">
              <div>
                ...
                <Input
                  type="email"
                  placeholder="demo@boardcraft.com"
                  value={email}
