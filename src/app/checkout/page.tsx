...
function CheckoutContent() {
  ...
  const tierInfo = game
    ? PRICING[game.tier as PricingTier]
    : PRICING.premium;
  const extraCopies = giftAddresses.length;
  const total = tierInfo.price * (1 + extraCopies);
              ...
              {giftMode && (
                <CardContent className="space-y-4">
                  <p className="text-sm text-gray-500">
                    Ship additional copies to friends and family. Each extra copy
                    is {tierInfo.display}.
                  </p>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span>{tierInfo.display}</span>
                  </div>
                  {extraCopies > 0 && (
                    <div className="flex justify-between">
                      <span className="text-gray-500">
                        Gift copies ({extraCopies})
                      </span>
                      <span>
                        ${((tierInfo.price * extraCopies) / 100).toFixed(0)}
                      </span>
                    </div>
                  )}
                  <div className="flex justify-between">
